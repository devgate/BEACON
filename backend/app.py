...
# Import Vision API Blueprint
try:
    from vision_api import vision_bp
    VISION_API_AVAILABLE = True
    logger.info("Vision API module loaded successfully")
except ImportError as e:
...
# Register Vision API Blueprint
if VISION_API_AVAILABLE and vision_bp:
    app.register_blueprint(vision_bp)
    logger.info("Vision API endpoints registered successfully")
